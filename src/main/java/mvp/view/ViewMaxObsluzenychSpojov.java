...
public class ViewMaxObsluzenychSpojov extends ViewMaxObsadenosti {
    private JTextField textFieldH;

    public ViewMaxObsluzenychSpojov(Presenter presenter) {
        super(presenter);
    }
    ...
    protected void vypocitajModel(Presenter presenter) throws Exception {
        ...
        String vysledok = presenter.vykonajMaximalizaciuObsluzenychSpojov(pocetBusov, pocetVodicov,h,
